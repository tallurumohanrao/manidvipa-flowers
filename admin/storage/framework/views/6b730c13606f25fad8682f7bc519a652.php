            			...
            			<table class="table table-bordered  table-hover tablegrid">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($row->id); ?>">
                                    ...
                                    <td><?php echo e(html()->img(asset('storage/'.$module.'/100X100/'. @$row->image ), null)->attributes(array('title' => @$row->name ,'width' => '70px'))); ?></td>
                                    <td>
                                        <label class="switch">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($module.'_edit')): ?>
                                            <a href="<?php echo e(route('admin.'.$module.'.edit',['testimonial'=>$row->id])); ?>"><i class="fas fa-edit p-1"></i></a>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($module.'_delete')): ?>
                                            <a href="javascript:;" class="delete" data-id="<?php echo e($row->id); ?>" data-url="<?php echo e(route('admin.'.$module.'.destroy',['testimonial'=>$row->id])); ?>"><i class="fas fa-trash text-danger p-1"></i></a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Projects\manidvipa-flowers\admin\resources\views/admin/testimonials/index.blade.php ENDPATH**/ ?>