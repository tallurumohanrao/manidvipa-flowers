...
<section class="content">
	<div class="container-fluid">
        <h4 class="heading text-capitalize">
            <a href="<?php echo e(route('admin.'.$module.'.index')); ?>">Shipping Statuses</a>
        </h4>
		<hr>
            			...
            			<table class="table table-bordered  table-hover tablegrid">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($row->id); ?>">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('admin.'.$module.'.edit',['shippingstatus'=>$row->id])); ?>"><i class="fas fa-edit p-1"></i></a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Projects\manidvipa-flowers\admin\resources\views/admin/shippingstatuses/index.blade.php ENDPATH**/ ?>