<div class="row">
    ...
    <div class="col-md-12">
        ...
        <small class="form-text text-muted">Example saved text: <code>Your order #@verbatim{{order.id}}@endverbatim delivery is pending.</code> Customer sees: <strong>Your order #125 delivery is pending.</strong></small>
    </div>
</div>
