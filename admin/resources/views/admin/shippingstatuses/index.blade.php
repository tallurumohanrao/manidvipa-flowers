...
<section class="content">
	<div class="container-fluid">
        <h4 class="heading text-capitalize">
            <a href="{{ route('admin.'.$module.'.index') }}">Shipping Statuses</a>
        </h4>
		<hr>
                            ...
                            @foreach($data as $row)
                                <tr id="row-{{ $row->id }}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @can($module.'_edit')
                                            <a href="{{ route('admin.'.$module.'.edit',['shippingstatus'=>$row->id]) }}" title="Edit shipping status" aria-label="Edit shipping status"><i class="fas fa-edit p-1" aria-hidden="true"></i></a>
                                            @endcan
