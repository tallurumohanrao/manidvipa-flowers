                            ...
                            @foreach($data as $row)
                                <tr id="row-{{ $row->id }}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @can($module.'_edit')
                                            <a href="{{ route('admin.'.$module.'.edit',['paymentstatus'=>$row->id]) }}" title="Edit payment status" aria-label="Edit payment status"><i class="fas fa-edit p-1" aria-hidden="true"></i></a>
                                            @endcan
