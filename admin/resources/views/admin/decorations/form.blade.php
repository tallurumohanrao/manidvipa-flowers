...
<div class="form-group row">
    <label class="col-sm-3 col-form-label" for="input_label_1">Input 1 Label</label>
    <div class="col-sm-9">
    {{ html()->text('input_label_1')->class('form-control')->placeholder('Input 1 Label')->required() }}
    </div>
</div>

<div class="form-group row">
    <label class="col-sm-3 col-form-label" for="input_label_2">Input 2 Label</label>
    <div class="col-sm-9">
    {{ html()->text('input_label_2')->class('form-control')->placeholder('Input 2 Label') }}
    </div>
</div>
