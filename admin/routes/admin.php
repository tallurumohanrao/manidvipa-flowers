...
Route::resource('orderstatuses', OrderStatusController::class)->except('show');
Route::resource('paymentstatuses', PaymentStatusController::class)->except('show');
Route::resource('shippingstatuses', ShippingStatusController::class)->except('show');
Route::resource('shippingprices', ShippingPriceController::class)->except('show');
...
Route::post('/daily-prices/voice-preview', [App\Http\Controllers\Admin\DailyPriceController::class, 'voicePreview'])->name('dailyprices.voice.preview');
Route::post('/daily-prices/voice-apply', [App\Http\Controllers\Admin\DailyPriceController::class, 'voiceApply'])->name('dailyprices.voice.apply');
...
Route::resource('contentblocks', ContentBlockController::class)->except(['show', 'destroy']);
