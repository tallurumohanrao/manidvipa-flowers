...
class AccountController extends BaseController
{
    ...
    public function orderDetails(Request $request)
    {
        ...
        $order = DB::table('orders as o')->select('o.id','o.order_encrypt_key','o.user_id','o.name','o.email','o.amount','o.order_status_id','o.created_at','o.updated_at','o.sub_total','os.name as order_status_name')->leftJoin('order_statuses as os', 'os.id', '=', 'o.order_status_id')->where(['o.user_id'=>$user_id,'o.order_encrypt_key'=>$order_encrypt_key])->first();
        if(!$order){
